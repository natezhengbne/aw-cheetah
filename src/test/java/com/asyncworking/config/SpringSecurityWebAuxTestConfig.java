...
public class SpringSecurityWebAuxTestConfig {
    ...
    public InMemoryUserDetailsManager userDetailsService(){
        GrantedAuthority companyManagerAuthority = new AwcheetahGrantedAuthority(RoleNames.COMPANY_MANAGER.value(), 1L);
        GrantedAuthority projectManagerAuthority = new AwcheetahGrantedAuthority(RoleNames.PROJECT_MANAGER.value(), 1L);
