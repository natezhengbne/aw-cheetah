    ...
    protected void configure(HttpSecurity http) {
        http
            ...
            return cors;
                ...
                .authorizeRequests()
                .antMatchers("/companies/{companyId:[\\d+]}/**").access("@guard.checkCompanyAccess(authentication, #companyId)")
                .antMatchers("/projects/{projectId:[\\d+]}/**").access("@guard.checkProjectAccess(authentication, #projectId)")
